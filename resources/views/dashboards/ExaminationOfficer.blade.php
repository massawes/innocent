@extends('layouts.app')
@section('page-title', 'Dashboard — Examination Officer')
...
<div class="row g-3">
    ...
    <div class="col-lg-8">
        <div class="ent-card h-100">
            <div class="ent-card-header">
                <h2 class="ent-card-title"><i class='bx bx-check-shield'></i> Exam Eligibility Status</h2>
                <span class="ent-badge ent-badge-warning">75% Rule</span>
            </div>
                    ...
                    <div class="col-sm-4">
                        <div style="background:var(--ent-bg);border:1px solid var(--ent-border);border-radius:var(--ent-radius);padding:1rem;text-align:center">
                            ...
                            <div style="font-size:.75rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;color:var(--ent-text-muted);margin-top:.3rem">
                                <i class='bx bx-check-circle' style="color:var(--ent-success)"></i> Cleared
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div style="background:var(--ent-bg);border:1px solid var(--ent-border);border-radius:var(--ent-radius);padding:1rem;text-align:center">
                            ...
                            <div style="font-size:.75rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;color:var(--ent-text-muted);margin-top:.3rem">
                                <i class='bx bx-x-circle' style="color:var(--ent-danger)"></i> Not Cleared
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div style="background:var(--ent-bg);border:1px solid var(--ent-border);border-radius:var(--ent-radius);padding:1rem;text-align:center">
                            ...
                            <div style="font-size:.75rem;font-weight:600;text-transform:uppercase;letter-spacing:.05em;color:var(--ent-text-muted);margin-top:.3rem">
                                <i class='bx bx-bar-chart-alt-2' style="color:var(--ent-primary)"></i> System Average
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-lg-4">
        <div class="ent-card h-100">
            <div class="ent-card-header">
                <h2 class="ent-card-title"><i class='bx bx-error'></i> Quick Alerts</h2>
                    ...
                    @foreach($lowAttendanceModules->take(4) as $module)
                        <div style="display:flex;align-items:center;justify-content:space-between;padding:.7rem 1.25rem;border-bottom:1px solid var(--ent-border-light)">
                            <div>
                                ...
                                <div style="font-size:.75rem;color:var(--ent-text-muted)">{{ $module->program_name ?? 'Overall' }}</div>
                            </div>
